...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Пожалуйста, введите корректные данные.",
		dateISO: "Пожалуйста, введите корректные данные (ISO).",
		number: "Пожалуйста, введите корректный номер.",
		digits: "Пожалуйста, вводите только цифры.",
		creditcard: "Пожалуйста, введите корректные данные карты.",
		equalTo: "Пожалуйста, введите то же самое еще раз.",
		accept: "Пожалуйста, введите значение с корректным расширением.",
